# Determine correct secret number based on hints
# Input
# Number of guesses
# Each guess with numbers and corresponding hint (A means count of correct positions, B means count of correct digits but wrong positions)
